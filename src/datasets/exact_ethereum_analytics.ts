...
export default defineDataset(() => ({
  namespace: "x402",
  name: "exact_ethereum_analytics",
  version: "0.2.0",
  description:
    "x402 payment analytics for Ethereum mainnet. Hourly/daily volume, top payers, " +
    "top recipients, first-seen tracking, and raw transfers derived from ampersend/exact_ethereum_mainnet.",
  keywords: ["x402", "analytics", "ethereum", "usdc", "payments", "agentic"],
  sources: ["https://github.com/edgeandnode/ampersend"],
  network: "ethereum-mainnet",
  dependencies: {
    eth: "ampersend/exact_ethereum_mainnet@latest",
  },
  tables: {
    daily_stats: {
      sql: `
