...
export default defineDataset(() => ({
  ...
  version: "0.1.0",
  description:
    "x402 payment analytics for Optimism mainnet. Daily volume, top payers, " +
    "and top recipients derived from ampersend/exact_optimism_mainnet.",
  keywords: ["x402", "analytics", "optimism", "usdc", "payments", "agentic"],
  sources: ["https://github.com/edgeandnode/ampersend"],
  network: "optimism-mainnet",
  dependencies: {
    optimism: "ampersend/exact_optimism_mainnet@latest",
  },
  tables: {
    daily_stats: {
      sql: `
